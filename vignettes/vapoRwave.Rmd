...
`r knitr::include_graphics(here::here("Readme_files/figure-gfm/cicero.png"))`
...
`r knitr::include_graphics(here::here("Readme_files/figure-gfm/digital_aes.jpg"))`
`r knitr::include_graphics(here::here("Readme_files/figure-gfm/ClKW.gif"))`
`r knitr::include_graphics(here::here("Readme_files/figure-gfm/snapshot.jpg"))`
...
`r knitr::include_graphics(here::here("Readme_files/figure-gfm/floralShoppe_palette.png"))`

### New Retro Palette

`r knitr::include_graphics(here::here("Readme_files/figure-gfm/newRetro_palette.png"))`

### jwz Palette

`r knitr::include_graphics(here::here("Readme_files/figure-gfm/jwz_palette.png"))`

### Hotline Bling Palette

`r knitr::include_graphics(here::here("Readme_files/figure-gfm/hotlineBling_palette.png"))`

### Hyper Bubble Palette

`r knitr::include_graphics(here::here("Readme_files/figure-gfm/hyperBubble_palette.png"))`
...
`r knitr::include_graphics(here::here("Readme_files/figure-gfm/FloralShoppe.png"))`
...
`r knitr::include_graphics(here::here("Readme_files/figure-gfm/new_retro.jpg"))`
...
`r knitr::include_graphics(here::here("Readme_files/figure-gfm/jwz.jpg"))`
